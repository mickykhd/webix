var ruLocale = {
	...
	Basic: "Основные",
	edited: "ред.",
	Connecting: "Подключения",
	"Line is busy": "Линия занята",
	"You have been removed from the group": "Вы были исключены из группы",
	"Already in the call": "Вы уже учавствуете в звонке",
	"Call is active in another chat": "Звонок активен в другом чате",
	"Internal call error": "Внутренняя ошибка звонка",
